...
// BoardingTemplateGetBuildParam ...
func BoardingTemplateGetBuildParam(params []interface{}) (commons.ProjectName, commons.Licence, commons.GroupRoleName, commons.Boarding, commons.Boarding, commons.Hash, commons.StateReason) {
...
// BoardingBuildParam ...
func BoardingBuildParam(params []interface{}) (string, commons.Template, commons.StateReason) {
...
// BoardingGetBuildParam ...
func BoardingGetBuildParam(params []interface{}) (string, commons.XPub, commons.StateReason) {
	return commons.BuildGetWithXPubParams(params)
}

// BoardingBroadcastBuildParam ...
func BoardingBroadcastBuildParam(params []interface{}) (string, []commons.UTXO, commons.Hash, commons.StateReason) {
	_type := params[0].(string)
...
// BoardingBroadcastGetBuildParam ...
func BoardingBroadcastGetBuildParam(params []interface{}) (string, commons.Hash, commons.StateReason) {
