...
// StoreBuildParam ...
func StoreBuildParam(params []interface{}) (string, commons.Trace, commons.StateReason) {
...
// HashAskBuildParam ...
func HashAskBuildParam(params []interface{}) (string, commons.Trace, commons.StateReason) {
	_type := params[0].(string)
