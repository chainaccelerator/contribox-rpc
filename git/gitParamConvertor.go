...
// StoreParamConvert ...
func StoreParamConvert(params []interface{}) (string, string, commons.XPub, commons.StateReason) {
...
// CommitHashAskParamConvert ...
func CommitHashAskParamConvert(params []interface{}) (string, commons.Hash, commons.XPub, commons.StateReason) {
	_type := params[0].(string)
